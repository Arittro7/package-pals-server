...
const UserRoleCollection = client.db("PackagePal").collection("Users");
const TotalDelivery = client.db("PackagePal").collection("Delivery");
...
app.get("/", (req, res) => {
  res.send("PackagePal Server Is Running");
});
